...
public class CreateCertificateTest {
    ...
    public void generateCertificate(String surname, String name, String city) throws InterruptedException {
        ...
        WebDriverWait wait = new WebDriverWait(chromeDriver, 80);
        ...
        WebElement generateButton = chromeDriver.findElementByXPath("//*[@id=\"root\"]/div/div[2]/div/div/div[5]/div/div/div/div[2]/div/div/div[3]/button");
